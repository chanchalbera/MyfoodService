<%@page import="com.cb.foodapp.entities.User"%>
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div class="d-flex align-items-center" style="margin-right: 20px">
					...
					<!-- Modern "Log Out" link -->
					<a href="userLogout" class="text-decoration-none text-light"> <i
	...
	<div class="container mt-2">
		...
		<a href="foodorder" class="btn btn-warning btn-admin btn-add-product">Order
			Food</a> <a href="viewPreviousOrder" class="btn btn-success btn-admin">View
			Previous Orders</a>
	</div>
 ...
 --%>
	...
	<script>
		window.onload = function() {
			// Clear any specific elements or data upon page load
			document.getElementById("successLoginAlert").innerText = "";
