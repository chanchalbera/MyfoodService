		...
		<form:form action="saveProduct" modelAttribute="product" method="post">
			...
			<div class="mb-3">
				...
				<form:input class="form-control"
					placeholder="Enter the product name" path="name" />
			</div>

			<div class="mb-3">
				<label for="text" class="form-label">Type:</label>
				<form:input placeholder="Enter the product type"
			...
			<div class="mb-3">
				...
				<form:input class="form-control"
					placeholder="Enter the product price" path="price" />
			</div>

			<div class="btn-center text-center mb-2">
				<button type="submit" class="btn btn-primary">Add Product</button>
				<a class="btn btn-success" href="AdminPanel.jsp">Back</a>
			</div>
		</form:form>
	</div>
